...
@section('title','Ajukan Perusahaan Baru')
...
<div class="row">
    <div class="col-md-12">
        <div class="alert alert-danger"><b>Pastikan</b> anda sudah diterima prakerin di tempat yang anda ajukan!</div>
    </div>
</div>
<div class="row">
    <div class="col-md-7">
    ...
    <div class="col-md-5">
        <div class="card">
            <div class="card-body">
                <span class="mt-0 header-title">Ajukan Perusahaan Baru</span>
                <hr>
                <form action="{{ route('pes.stpr') }}" method="POST">
                    @csrf
